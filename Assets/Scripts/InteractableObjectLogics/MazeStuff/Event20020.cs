...
public class Event20020 : MonoBehaviour
{
    ...
    private void ExtractEvent()        //按照权重抽取事件
    {
        ...
        eventId = EventManager.Instance.GetRandomLibId(2) * 10 + 1;
    ...
    void OnTriggerEnter2D(Collider2D collision)
    {
        if(collision.gameObject.CompareTag("Player"))
        {
            ...
            GameLevelManager.Instance.eventList.Add(new ResultEvent("事件" + myEvent.eventId, 2, 1));
