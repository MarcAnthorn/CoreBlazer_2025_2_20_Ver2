...
public class FigureDesk : MonoBehaviour
{
    public int itemId = 513; // 道具ID，由用户填写
    ...
    void Awake()
    {
        ...
        else
        {
            ...
            Debug.Log($"[FigureDesk] 首次注册道具点到字典，状态: false, 关卡: {GameLevelManager.Instance.gameLevelType}, 坐标: {this.transform.position}, ItemId: {itemId}");
        }
    }
    ...
    private void CollectItem()
    {
        ...
        Debug.Log($"[FigureDesk] 道具被收集，状态已写入字典: true, 关卡: {GameLevelManager.Instance.gameLevelType}, 坐标: {this.transform.position}, ItemId: {itemId}");
        ...
        UIManager.Instance.ShowPanel<AVGPanel>().InitAVG(2310);
